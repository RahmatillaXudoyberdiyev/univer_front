    ...
    return (
        <section className="container-cs py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 md:gap-8 items-center">
                                        ...
                                        <React.Fragment key={index}>
                                            <div className="flex items-start gap-5 md:gap-8">
                                                ...
                                                <div className="flex-1 pt-2">
                                                    <h2 className="text-xl md:text-2xl font-bold text-[#05053C] dark:text-white mb-2 leading-tight">
                                                        {official.name}
                                                    </h2>
                ...
                <div className="col-span-12 xl:col-span-6  order-1 lg:order-2">
                ...
                `}</style>
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'pahtachiyskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'nurabadskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'kattakurganskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'koshrabadskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'payarikskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'djambayskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'samarkandskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'bulungurskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'ishtihanskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                ...
                                <path
                                    ...
                                    className={`sam-path ${
                                        activeRegion === 'pastdargomskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                />
                                <path
                                    d="M620.33,437.33l-11.16-1.83L597,428.33h-6.33s-6.34-5-6.84-5.33-10-2.67-10-2.67L572.67,413l-3.17-2.17-3.17-5.16-4.18-2-5,.67s-3.34-1.5-3.84-1.33a13.88,13.88,0,0,0-2,1.33H545.5l-16.67-4L508.67,396l-17.46-7.88s4.29-7.12,5.12-18.45-3.16-14.5-4.5-18.67-1.66-6-.83-7.33,8.83,1.66,8.83,1.66a14.24,14.24,0,0,1,6.84-2.5c3.66-.16,9.83,6,9.83,6l14,8h8.83s8.34,1.67,10.67,5.5,25.67,35.34,25.67,35.34,11.33,7.66,11.83,7.83,12.83,8.5,12.83,8.5l8,3,7.8,12.17Z"
                                    id="akdarinskiy-rayon"
                                    className={`sam-path ${
                                        activeRegion === 'akdarinskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
                                />
                                <path
                                    d="M725.1,494.79l-2.93,5.54a16.59,16.59,0,0,0-8.5,2.67l-10.84-.83-3.5,5-16.66-.5-6.84,8.66s-2.83.17-11.83-1-20-17-20-17c-8.83-3.33-19.5,2.17-20,2.5s-2.83-4.33-2.83-4.33l-2-4.83s-6.67-3.84-5.34-5.5,5.17,0,5.17,0h5l2-4.5-1.67-11.5,2.84-3.67s.16-3,.16-3.33,7.17,0,7.17,0l.67-4.5c5-.84,6.5,2.66,9.33,6.33s10.33,3.17,10.33,3.17a135.3,135.3,0,0,0,23,14.6,161.24,161.24,0,0,0,27.38,11.06l17,.34Z"
                                    id="taylakskiy-rayon"
                                    className={`sam-path ${
                                        activeRegion === 'taylakskiy-rayon'
                                            ? 'active-region'
                                            : ''
                                    }`}
                                    onClick={handleRegionClick}
