            ...
            <div className="container-cs flex items-center justify-between">
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-3">
                  <span className="text-sm">{t('Shrift olchami')}:</span>
                  <div className="flex gap-2">
                    <button
                      onClick={() => updateFontSize('14px')}
                      className="bg-white text-black px-3 py-1 rounded text-xs"
                    >
                      Aa
                    </button>
                    <button
                      onClick={() => updateFontSize('16px')}
                      className="bg-white text-black px-3 py-1 rounded text-sm"
                    >
                      Aa
                    </button>
                    <button
                      onClick={() => updateFontSize('20px')}
                ...
                <div className="flex items-center gap-3 border-l border-white/20 pl-8">
                  <span className="text-sm">{t('Rang sxemasi')}:</span>
                  <div className="flex gap-2">
                    <button
                ...
                <div className="flex items-center gap-3 border-l border-white/20 pl-8">
                  <span className="text-sm">{t('Tasvirlar')}:</span>
                  <div className="flex gap-2">
                    <button
