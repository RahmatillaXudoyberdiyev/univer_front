...
import { ChevronRight, Database, Folder, LayoutTemplate } from 'lucide-react'
import { getTranslations } from 'next-intl/server'
import { cookies } from 'next/headers'
import Link from 'next/link'

export async function AdminSidebar() {
  const res = await fetch(`${baseBackendUrl}/menu`, {
    headers: {
      'Content-Type': 'application/json',
    },
    next: { tags: ['admin-sidebar-menus'] },
  })
  ...
  const dynamicItems = menuData.map((item: Record<string, any>) => ({
