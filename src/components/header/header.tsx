    ...
    const menuItems = [
        ...
        },
        {
            ...
            items: {
                ...
                "Tarkibiy tuzilma": "/tarkibiy_tuzilma",
                "Vazifalari va funksiyalari": "/vazifalar",
                "Bo'sh ish o'rinlari": "/bosh_ish_ornlari",
        ...
        },
        {
            ...
            items: {
                ...
                "Farmonlar": "/farmonlar",
                "Qarorlar": "/qarorlar",
                "Me'yoriy hujjatlar": "/meyoriy_hujjatlar"
            }
        },
        {
            title: 'Tashqi savdo',
            ...
            <div className="container-cs">
                <ul className="hidden md:flex">
                    {menuItems.map((menu, index) => {
                        const hasDropdown = Object.keys(menu.items).length > 1 || !menu.items["default"];
                        return (
                            <li
                                key={index}
                            ...
                            >
                                {menu.items["default"] ? (
                                    <Link href={menu.items["default"]} className="flex items-center gap-1.5 px-4 py-5 hover:bg-white/5 transition-colors duration-200 whitespace-nowrap">
                                ...
                                {hasDropdown && (
                                    <div
                                        className={`absolute left-0 top-full w-64 bg-white dark:bg-slate-900 shadow-2xl border-t-2 border-blue-600 dark:border-blue-500 overflow-hidden transition-all duration-300 ${
                                            activeMenu === index
                                            ...
                                            {Object.entries(menu.items)
                                                ...
                                                .map(([label, path], itemIndex) => (
                                                    <li
                                                        ...
                                                        style={{
                                                            transitionDelay: activeMenu === index ? `${itemIndex * 40}ms` : '0ms'
                                                        }}
                                                    >
                                                        <Link
                                                            href={path}
                                                        ...
                                                        >
                                                            <span className="absolute left-4 top-1/2 -translate-y-1/2 w-0 h-0.5 bg-blue-600 dark:bg-blue-500 group-hover/item:w-2 transition-all duration-200" />
                                                            {label}
                                                        </Link>
                                                    </li>
                                                ))}
