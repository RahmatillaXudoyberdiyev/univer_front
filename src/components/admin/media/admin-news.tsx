                    ...
                    >
                        ...
                        <Link href="">
                            <h2 className="font-bold text-lg mt-1 line-clamp-2">
                                Today marks 34 years since the adoption of the
                                Law..
                            </h2>
                        </Link>
                        <p className="pt-2 text-gray-600 line-clamp-3">
                            Our State Flag is a symbol of our national identity
                            and one of the main emblems that represents the name
                            ...
                        </p>
                    </motion.div>
                ))}
                        ...
                        {activeTab === 'news' && (
                            <>
                                <div className="w-full">
                                    <div className="flex justify-start items-center gap-3 flex-wrap w-full"></div>
                                </div>
                            </>
                        )}
                    </DialogContent>
