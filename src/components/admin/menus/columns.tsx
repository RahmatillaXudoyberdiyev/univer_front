      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="grid grid-cols-3 gap-2 text-sm">
            ...
            <span>{nameUz || '—'}</span>
            <span></span>
            <span className="font-medium text-muted-foreground">Русский:</span>
            <span>{nameRu || '—'}</span>
            <span></span>
            <span className="font-medium text-muted-foreground">English:</span>
            <span>{nameEn || '—'}</span>
            <span></span>
            <span className="font-medium text-muted-foreground">О'збекча:</span>
            <span>{nameOz || '—'}</span>
          </div>
        )
      },
